...
export const teamMembers: TeamMember[] = [
  ...
  },
  {
    name: 'Henry McCreery',
    role: 'Developer',
    photoUrl: '/images/team/testimage.webp',
    bio: 'Lead developer for the project, responsible for building and deploying the application. Handles the Firebase setup, page development, and the deployment pipeline.',
  },
  {
    name: 'Justin Agra',
